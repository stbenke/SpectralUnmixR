...
```{r median data}
d_beads_pos_median <- GetMedianData(d_beads_pos)
d_beads_neg_median <- GetMedianData(d_beads_neg)

d_arc_pos_median <- GetMedianData(d_arc_pos)
d_arc_neg_median <- GetMedianData(d_arc_neg)

d_cells_unstained_median <- GetMedianData(d_cells_unstained)
```
...
SingleStainVariability displays the calculated reference spectra together with the spectra plot of the original data after subtracting the carrier fluorescence.
